...
use sc_client_api::{
	...
	CallExecutor, ExecutionProofProvider, ExecutorProvider, KeysIter, OnFinalityAction,
	OnImportAction, PairsIter, PrefetchedIndexedTransactions, ProofProvider, StaleBlock,
	TrieCacheContext, UnpinWorkerMessage, UsageProvider,
};
use sc_consensus::{
...
impl<B, E, Block, RA> ExecutionProofProvider<Block> for Client<B, E, Block, RA>
where
	B: backend::Backend<Block>,
	E: CallExecutor<Block>,
	Block: BlockT,
